...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="E-School/style.css">
    <link rel="icon" href="E-School/images/logo.png">
...
<body>
    ...
    <div id="lock">
        <header id="main-header">
            <div class="container">
                <div id="logo">
                    <img src="E-School/images/logo.png" alt="E-SCHOOL LOGO" width="100" height="100">
                </div>
            </div>
        ...
        <nav id="navbar">
            <div class="container">
                ...
                <ul>
                    ...
                    <li><a href="E-School/contact.php">Contact</a></li>
                    <li><a href="E-School/login.php">Login</a></li>
                    <li><a href="E-School/signup.php">Sign up</a></li>
                </ul>
            </div>
    ...
    <section id="showcase">
        <div class=" slideshow-container ">
            ...
            <div class="mySlides fade ">
                ...
                <img src="E-School/images/img1.jpg" style="width:100%">
                <div class="text "></div>
            </div>

            <div class="mySlides fade ">
                <div class="numbertext ">2 / 3</div>
                <img src="E-School/images/img2.png " style="width:100%">
                <div class="text "></div>
            </div>

            <div class="mySlides fade ">
                <div class="numbertext ">3 / 3</div>
                <img src="E-School/images/img3.jpg " style="width:100%">
                <div class="text "></div>
            </div>
        ...
        <script src="E-School/script.js"></script>
